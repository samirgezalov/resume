...
class S {
  ...
  /// `Bachelor in Drilling Engineering`
  String get degree {
    return Intl.message(
      'Bachelor in Drilling Engineering',
      name: 'degree',
  ...
  /// `Azerbaijan State Oil Academy (ASOA) 2002-2006`
  ...
  String get selfEvaluationData {
    return Intl.message(
      'Temper Positive and Optimistic \nCheerful \nHonest and trustworthy \nWilling to help others \nResponsible \nWith a strong team spirit and strong ability to work \nNonPro Skills Good PC management knowledge, good overall IT knowledge \nLanguage Russian, English, Azeri, all fluent',
      name: 'selfEvaluationData',
      desc: '',
      args: [],
    );
  }
  ...
  String get drillingSoftData {
    return Intl.message(
      'DIMS\nOpen Wells\nWell Plan\nStress Check\nWell Cat\nCompass\nCasing Wear\nDrilling Office\nWell, Trajectory, BHA T&D, Tendency, Hydraulics, Sag correction, stabilization, Anti-Collision analysis\nMS Office World, Excell, Project (Microsoft training passed), Powerpoint (training not needed)',
      name: 'drillingSoftData',
      desc: '',
      args: [],
    );
  }
